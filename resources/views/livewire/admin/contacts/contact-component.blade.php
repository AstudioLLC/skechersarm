<div>
    ...
    <div class="row pb-3">
        <div class="col-6">
{{--            <a class="btn btn-light py-3 px-5 text-black w-100" href="{{route('admin.contact.create')}}">Create new {{$this->name}}</a>--}}
        </div>
        <div class="col-6">
            <a href="{{route('admin.contact.trashed')}}" class="float-right btn btn-light py-3 px-5 text-black w-100">Trashed</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{$name_contact}} Table</h5>
...
{{--                                    </td>--}}
                                    ...
                                    <td>
                                        {{\Illuminate\Support\Str::limit($item->message,25)}}
                                    ...
                                    <td>
                                        <a href="{{route('admin.contact.edit',['id'=>$item->id ?? null])}}" class="px-2">
