    ...
    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateSlide">
            ...
            <div class="col-6">
                <div class="form-group has-danger" >
                    ...
                    <sec-tab-container wire:ignore>
                        ...
                        <sec-tab-content>
                            <input type="text" class="form-control @error('button.en') form-control-alternative is-invalid @enderror button-en" id="en" wire:model.defer="button.en" placeholder="Enter English Button">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('button.hy') form-control-alternative is-invalid @enderror button-hy" id="hy" wire:model.defer="button.hy" placeholder="Enter Armenian Button">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('button.ru') form-control-alternative is-invalid @enderror button-ru" id="ru" wire:model.defer="button.ru" placeholder="Enter Russian Button">
                        </sec-tab-content>
        ...
        <div class="form-group has-danger">
            ...
            <tab-container wire:ignore>
                ...
                <tab-content>
                    <textarea type="text" name="description.en" class="form-control description-en" id="en1" wire:model.defer="description.en" placeholder="Enter English Description"></textarea>
                </tab-content>
                <tab-content>
                    <textarea type="text" name="description.hy" class="form-control description-hy" id="hy1" wire:model.defer="description.hy" placeholder="Enter Armenian Description"></textarea>
                </tab-content>
                <tab-content>
                    <textarea type="text" name="description.ru" class="form-control description-ru" id="ru1" wire:model.defer="description.ru" placeholder="Enter Russian Description"></textarea>
                </tab-content>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    @else
                        <img src="{{asset('images/slides')}}/{{$image}}" class="img d-block mb-2 w-100 rounded uploading-image">
                    @endif
                </div>
