<div>
    <div class="row pb-3">
        <div class="col-6">
            <a class="btn btn-light py-3 px-5 text-black w-100" href="{{route('admin.social_network')}}">Go Back</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($items as $item)
                                <tr  wire:sortable.item="{{$item->id}}" wire:key="slide-{{$item->id}}" >
                                    ...
                                    <td>
                                        <img src="{{asset('images/social_network')}}/{{$item->image}}" class="fa-xs" alt="user1">
                                    </td>
                                    <td>
                                        {{$item->title}}
                                    </td>
