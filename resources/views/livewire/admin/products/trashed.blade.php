<div>
    ...
    <div class="row pb-3">
        <div class="col-6">
            <a class="btn btn-light py-3 px-5 text-black w-100" href="{{route('admin.products')}}">Go Back</a>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            @foreach($items as $item)
                                <tr  wire:sortable.item="{{$item->id}}" wire:key="product-{{$item->id}}" >
                                    <th scope="row" wire:sortable.handle>
                                        <i class="ni ni-bullet-list-67" id="bullet"></i>
                                    </th>
                                    <td>
                                        <img width="200px" src="{{asset('images/products')}}/{{$item->image}}" class="fa-xs" alt="user1">
                                    </td>
                                    <td>
                                        {{$item->name}}
                                    </td>
