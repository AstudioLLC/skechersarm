<div>
    ...
    <div class="row pb-3">
        <div class="col-6">
            <a class="btn btn-light py-3 px-5 text-black w-100" href="{{route('admin.information.create')}}">Create new {{$this->name}}</a>
        </div>
        <div class="col-6">
            <a href="{{route('admin.information.trashed')}}" class="float-right btn btn-light py-3 px-5 text-black w-100">Trashed</a>
...
{{--                                <th scope="col">Phone_2</th>--}}
                            ...
                            @foreach($items as $item)
                                <tr  wire:sortable.item="{{$item->id}}" wire:key="slide-{{$item->id}}" >
                                    ...
                                    <td>
                                        <a href="{{route('admin.information.edit',['id'=>$item->id ?? null])}}" class="px-2">
