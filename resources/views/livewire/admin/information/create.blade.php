            ...
            <div class="col-6">
                <div class="form-group has-danger" wire:ignore>
                    ...
                    <sec-tab-container >
                        ...
                        <sec-tab-content>
                            <input type="text" class="form-control @error('address.en') form-control-alternative is-invalid @enderror address-en" id="en" wire:model.defer="address.en" placeholder="Enter English Title">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('address.hy') form-control-alternative is-invalid @enderror address-hy" id="hy" wire:model.defer="address.hy" placeholder="Enter Armenian Title">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('address.ru') form-control-alternative is-invalid @enderror address-ru" id="ru" wire:model.defer="address.ru" placeholder="Enter Russian Title">
                        </sec-tab-content>
