<div>
    ...
    <div class="row pb-3">
        <div class="col-12">
            <a class="btn btn-light py-3 px-5 text-black w-100">Manage Brands</a>
        </div>
    </div>
...
{{--                                <th scope="col">To Home</th>--}}
{{--                                <th scope="col">To Menu</th>--}}
                            ...
                            @foreach($items as $item)
                                <tr>
                                    <td>
                                        <img src="{{asset('images/brands')}}/{{$item->image}}" class="avatar avatar-sm me-3" alt="user1">
                                    </td>
                                    <td>
                                        {{$item->id}}
                                    </td>
...
{{--                                    <td>--}}
{{--                                        @livewire('admin.supports.toggle-switch',  ['model' => $item, 'field' => 'to_home'], key($item->id))--}}
{{--                                    </td>--}}
{{--                                    <td>--}}
{{--                                        @livewire('admin.supports.toggle-switch',  ['model' => $item, 'field' => 'to_menu'], key($item->id))--}}
{{--                                    </td>--}}
                                    <td>
            ...
            <div class="col-6">
                <div class="form-group has-danger" wire:ignore>
                    ...
                    <sec-tab-container >
                        ...
                        <sec-tab-content>
                            <input type="text" class="form-control @error('content.en') form-control-alternative is-invalid @enderror content-en" id="en" wire:model.defer="content.en" placeholder="Enter English Title">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('content.hy') form-control-alternative is-invalid @enderror content-hy" id="hy" wire:model.defer="content.hy" placeholder="Enter Armenian Title">
                        </sec-tab-content>
                        <sec-tab-content>
                            <input type="text" class="form-control @error('content.ru') form-control-alternative is-invalid @enderror content-ru" id="ru" wire:model.defer="content.ru" placeholder="Enter Russian Title">
                        </sec-tab-content>
