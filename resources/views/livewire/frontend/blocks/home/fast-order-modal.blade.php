            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-block border-top-0">
                        ...
                        <button type="submit" href="#" class="btn btn-primary px-3">Ուղարկել պատվերը</button>
                        </div>
                    </div>
                </div>
            </div>
