    ...
    <div class="container">
        <div class="row">
            <div class="col-lg col-12 mb-3">
                <img src="{{ asset('images/logo.svg') }}" class="img-fluid mb-4" alt="">
                <p class="fs-6">
                    <a href="#" class="text-reset text-decoration-none"><img src="{{ asset('images/icons/location.svg') }}" class="img-fluid me-2" alt="">{{$information->address}}</a>
                </p>
                <p class="fs-6">
                    <a href="tel:{{$information->phone}}" class="text-reset text-decoration-none"><img src="{{asset('images/icons/phone.svg')}}" class="img-fluid me-2" alt="">{{$information->phone}}</a>
                </p>
                <p class="fs-6">
                    <a href="mailto:{{$information->email}}" class="text-reset text-decoration-none"><img src="{{asset('images/icons/mail.svg')}}" class="img-fluid me-2" alt="">{{$information->email}}</a>
                </p>
                <p>
                    <a href="https://www.fb.com" class="text-reset text-decoration-none me-4" target="blank">
                        <img src="{{asset('images/icons/fb.svg')}}" class="img-fluid" alt="">
                    </a>
                    <a href="https://www.fb.com" class="text-reset text-decoration-none me-4" target="blank">
                        <img src="{{asset('images/icons/insta.svg')}}" class="img-fluid" alt="">
                    </a>
                    <a href="https://www.fb.com" class="text-reset text-decoration-none" target="blank">
                        <img src="{{asset('images/icons/youtube.svg')}}" class="img-fluid" alt="">
                    </a>
                </p>
                <p>
                    <a  class="text-reset text-decoration-none me-1" target="blank">
                    ...
                    <a class="text-reset text-decoration-none" target="blank">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="55" height="35" viewBox="0 0 35 15">
                            <defs>
                ...
                <p>
                    <a  class="text-reset text-decoration-none" target="blank">
                        <img src="{{asset('images/icons/Artboard6.svg')}}" class="img-fluid" alt="">
                    </a>
                </p>
            </div>
                ...
                <ul class="nav flex-column">
                    @if($headerPages)
                        @foreach($headerPages as $headerPage)
                            <li class="nav-item">
                                <a class="nav-link text-reset ps-0 fs-7 d-inline-block" href="{{$headerPage->route}}">{{$headerPage->title ?? null}}</a>
                            </li>
                        @endforeach
                    @endif
                </ul>
            ...
            <div class="col-lg col-sm-6 col-12 fs-6 mb-3">
                ...
                <ul class="nav flex-column">
                    @foreach($pagesForInformation as $pageForInformation)
                        <li class="nav-item">
                            <a class="nav-link text-reset ps-0 fs-7 d-inline-block" href="{{$pageForInformation->route}}">{{$pageForInformation->title}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            <div class="col-lg col-sm-6 col-12 fs-6 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    {{--                    <li class="nav-item">--}}
                    {{--                        <a class="nav-link text-reset ps-0" href="{{$pageForBuyers->route}}">{{$pageForBuyers->title}}</a>--}}
                    {{--                    </li>--}}
                    {{--                    @endforeach--}}
                    @foreach($frontCategories as $category)
                        <li class="nav-item">
                            <a class="nav-link text-reset ps-0 fs-7 d-inline-block" href="{{ route('category', [$category->slug]) }}">{{$category->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            <div class="col-lg col-sm-6 col-12 fs-6">
                ...
                <ul class="nav flex-column">
                    ...
                    @foreach($frontCategoriesFooter as $parentCategory)
                        ...
                        @foreach($parentCategory->footerCategories as $category)

                            @foreach($category->footerCategories as $childCategory)
                                <li class="nav-item">
                                    <a class="nav-link text-reset ps-0 fs-7 d-inline-block" href="{{ route('category',
                                                    [$parentCategory, $category->slug,$childCategory->slug])}}">{{$childCategory->name}}</a>
                                </li>
