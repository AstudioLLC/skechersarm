...
<div class="d-flex gap-3 justify-content-end mt-3">
    <div class="form-check shadow-sm p-2 ps-5 pe-4">
        <input class="form-check-input" type="radio" value="0" name="ship_method" id="flexCheckDefault">
        <label class="form-check-label" for="flexCheckDefault">
            Վերցնել խանութից
        </label>
    </div>
    <div class="form-check shadow-sm p-2 ps-5 pe-4">
        <input class="form-check-input" type="radio" value="1" name="ship_method" id="flexCheckDefault2">
...
<div class="row mt-4">
    <div class="col-12 col-md-4">
        <div class="form-group">
            ...
            <select class="form-select bg-light border-0 p-2 mt-2" name="city" wire:model="city" aria-label="Default select example">
    ...
    <div class="col-12 col-md-4">
        <div class="form-group" >
            ...
            <select class="form-select bg-light border-0 p-2 mt-2"  name="district" wire:model="regions" aria-label="Default select example"  >
                <option  value="">Choose City</option>
                @if (!is_null($region))
    ...
    <div class="col-12 col-md-4">
        <div class="form-group">
            ...
            <select class="form-select bg-light border-0 p-2 mt-2"  name="address" aria-label="Default select example">
                @foreach($storeAddresses as $storeAddress)
                    <option selected>{{$storeAddress->location}}</option>
                @endforeach
            </select>
        </div>
    </div>
...
<div class="d-flex gap-3 justify-content-end mt-3 flex-wrap">
    <div class="form-check shadow-sm p-2 ps-5 pe-4">
        <input class="form-check-input" type="radio" name="payment_type" value="0" id="flexCheckDefault">
        <label class="form-check-label" for="flexCheckDefault">
            Վճարել խանութում
        </label>
    </div>
    <div class="form-check shadow-sm p-2 ps-5 pe-4">
        <input class="form-check-input" type="radio" name="payment_type" value="1" id="flexCheckDefault2">
        <label class="form-check-label" for="flexCheckDefault2">
            Վճարում օնլայն
        </label>
    </div>
...
<div class="d-flex gap-3 justify-content-end mt-3 flex-wrap">
    ...
    <div class="form-check shadow-sm p-2 ps-5 pe-4 d-flex align-items-center justify-content-between gap-3">
        <input class="form-check-input" type="radio" value="idram" name="online_payment_type" id="flexCheckDefault2">
        <label class="form-check-label" for="flexCheckDefault2">
    ...
    <div class="d-flex justify-content-end mt-4 gap-5 me-2 fw-bold">
        ...
        <p class="m-0">{{$deliveryprice}}֏</p>
    </div>
    @endif
<div class="d-flex justify-content-end mt-2 gap-5 me-2 fw-bold">
    <p class="m-0">Ընդամենը՝</p>

    <p class="m-0">@if($region && $regions && $deliveryprice) {{$deliveryprice+Cart::instance('cart')->subtotal}}֏ @else  {{Cart::instance('cart')->subtotal}}֏ @endif</p>
    @if($deliveryprice && ($region) && ($regions))
